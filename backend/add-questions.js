...
/* =====================================================
   🌱 REAL QUESTION SEEDER (42 Questions)
   ===================================================== */
router.get('/seed-defaults', async (req, res) => {
    try {
        ...
        for (let setId = 1; setId <= 7; setId++) {
            // Logic from your script: Select 6 MCQs per set
            ...
            // Always add the same descriptive question at the end
